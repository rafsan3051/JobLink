      ...
      <div class="site-navbar bg-light">
        <div class="py-1">
          <div class="row align-items-center">
            <div class="col-2">
              <h2 class="mb-0 site-logo"><a href="/">Job<strong class="font-weight-bold" style = "color: #009063;">Link</strong> </a></h2>
            </div>
            <div class="col-10">
...
unset($__errorArgs, $__bag); ?>
  ...
  <?php /**PATH F:\VSCODE\JobLink\resources\views/frontend/partials/nav.blade.php ENDPATH**/ ?>